      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-surface-100 p-8 shadow-soft border border-gold-border">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            Or{' '}
            <Link to="/signup" className="font-medium text-brand-400 hover:text-brand-300 underline transition-colors">
        ...
        <div className="mt-6">
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-gold-border/50" />
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="bg-surface-100 px-3 text-gray-400 font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-gold-border bg-black px-4 py-3 text-sm font-medium text-white hover:bg-surface-50 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 focus:ring-offset-black transition-all duration-200"
            >
